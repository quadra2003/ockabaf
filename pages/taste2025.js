...
function SponsorshipForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto overflow-hidden">
      ...
      {/* Individual Tickets Section - moved to top */}
      <div id="tickets-section" className="mb-12">
        ...
        <p className="text-gray-600 text-center mb-8">
          Purchase tickets for the Taste of Korea 2025 event
        </p>
        ...
        {/* Ticket Purchase Form - shows directly below tickets when selected */}
        {selectedTicket && (
        ...
        <div className="grid gap-6">
          {sponsorshipTiers.map((tier) => (
            <div key={tier.id}>
              ...
              {/* Sponsorship Purchase Form - shows directly below selected tier */}
              {selectedTier?.id === tier.id && (
                <div className="bg-white border border-gray-200 rounded-lg p-8 mt-4 mb-8">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold text-gray-900">
